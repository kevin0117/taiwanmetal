...
RSpec.describe PriceBoard, type: :model, price: true do
  # before do
  user1 = FactoryBot.create(:user, first_name: 'Kevin', last_name: 'Wang', password: '123456')
  user2 = FactoryBot.create(:user, first_name: 'Annie', last_name: 'Wang', password: '123456')
  # end
